					...
					<article class="box">
						...
						<div class="box">
							<?php
								...
								$pincode=$_REQUEST['id'];
								include "connection.php";
								$sql="select * from rate b inner join region r on b.PinCode=r.PinCode where b.PinCode='$pincode'";
								...
								<table>
								<thead>
								<tr><th colspan="2"><div align="center"><?=$count++; ?></div></th></tr>
								</thead>
								<tr><td>Pin Code</td><td><?php echo $arr['PinCode']; ?></td></tr>
								<tr><td>Region Name</td><td><?php echo $arr['RegionName']; ?></td></tr>
								<tr><td>Consuption Range</td><td><?php echo $arr['ConsuptionRange']; ?></td></tr>
								<tr><td>Cost</td><td><?php echo $arr['UnitCost']; ?></td></tr>
								</table>
							<?php }}
								else{
										echo "No Data Found";
